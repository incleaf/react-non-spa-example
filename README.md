...
Webpack will bundle files separately declared on constant [`ENTRIES`](https://github.com/incleaf/react-non-spa-example/blob/master/webpack.config.js#L6) in [`webpack.config.js`](https://github.com/incleaf/react-non-spa-example/blob/master/webpack.config.js).
...
If you declare entry component and create store in the same file, React Hot Loader will not work correctly.
